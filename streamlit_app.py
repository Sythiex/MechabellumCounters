...
unit_matrix = {
    "Crawler":        [C, B, D, A, F, F, A, D, A, A, F, F, D, B, D, S, F, C, F, A, A, D, F, F, D, F, D, D, F],
    "Fang":           [D, C, D, A, F, B, D, F, C, F, A, B, D, D, D, S, F, F, F, C, B, D, B, B, D, F, F, D, F],
    "Hound":          [A, A, C, D, D, F, C, D, D, B, F, F, D, C, D, C, F, D, D, D, C, D, F, F, D, D, D, D, F],
    ...
    "Mustang":        [D, B, D, B, D, B, C, F, F, D, A, C, D, D, D, A, D, D, F, D, D, D, B, B, D, D, D, D, D],
    "Sledgehammer":   [A, S, B, C, A, F, S, C, D, B, F, F, D, D, D, D, F, F, D, F, D, D, F, F, F, D, B, D, F],
    ...
    "Rhino":          [C, C, B, C, A, F, B, B, D, S, F, F, B, D, C, D, F, A, A, D, F, D, F, F, F, A, A, A, F],
    "Hacker":         [F, F, C, F, A, F, D, A, S, F, F, F, C, D, A, C, F, A, D, F, B, D, F, F, F, A, A, D, F],
    "Wraith":         [S, B, S, D, S, S, B, A, A, S, D, D, A, A, A, S, C, A, A, A, F, A, D, D, A, S, D, D, F],
    "Scorpion":       [D, S, A, D, A, F, A, A, S, D, F, F, B, D, D, D, F, C, S, D, D, D, F, F, D, S, S, B, F],
    ...
    "Melting Point":  [D, D, D, C, A, D, C, A, D, D, B, B, A, B, S, C, S, A, S, S, C, B, A, B, B, A, A, A, A],
    ...
    "War Factory":    [B, A, A, A, S, F, A, S, A, B, F, F, S, A, A, A, F, A, S, B, D, A, F, F, C, S, A, A, F],
